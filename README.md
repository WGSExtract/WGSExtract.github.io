...
>NOTE: If your release states it is v44 from December 2022 or January 2023, then the microarray generator for Build 38 files (Nebula default) will not work properly (nor report an error). If your release is from 2022 or before, it will not work to realign a recent Nebula file due to their changes in the sequencer IDs. If you delete your program/program.json file and run the installer, it will adjust you to the latest available release but not the v44 Dec/Jan one. If you simply rerun the installer once we post the fix, you will update to the v44.2 (28 Feb 2023) release or later.
