...
| **[Dev(eloper) v4+](https://get.wgse.io/WGSExtract-Dev_latest_installer.zip)** | 44.11 | 19 Sep 2025 | 7966e35bd1360c1343a2406bf7e23449 |

Facebook group [Personal WGS](https://www.facebook.com/groups/PersonalWGS/)
...
* Apple MacOS 12 (Monterrey), 13 (Ventura), 14 (Sonoma), 15 (Sequoia) and 26 (Tahoe) on Intel and Apple M1/M2 processors. (note: We rely on Macports which has dropped support for Big Sur and earlier already)
* Ubuntu Linux LTS 20.04, 22.04 and 24.04. We recommend 24.04 to get the latest Samtools release. (note: 18.04 is deprecated due to dropped support for needed tool ports. 26.04 support soon.)
