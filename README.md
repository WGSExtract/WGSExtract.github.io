...
The BetaV2b release was simple and quick.  The 4.5 GB zip archive consists of 4.2 GB of Human Genom Reference Models that are sometimes needed. But it is this large size that gives most some issue with installing.  Therefore, we have created three separate .zip archives to aid the installation.
