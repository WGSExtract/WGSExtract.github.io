...
:stop sign:`**IMPORTANT**`: [MacOSX Patch Release](https://github.com/WGSExtract/WGSExtract-Dev/blob/master/docs/Betav2b_MacOSX_patch.md) for Version v2B above.  Fixes the install and running of the program. A complete replacement. (25 April 2020)
...
:us:`**Note**`: The tool acronym is **WGSE** and pronounced as "wig-see". We encourage this use in English conversation.
